...
const StaffDashboard = () => {
  ...
  const fetchAssignedComplaints = async () => {
    try {
      const response = await axios.get("http://localhost:3000/api/staff/complaints", {
  ...
  const handleUpdateStatus = async (complaintId, newStatus) => {
    try {
      await axios.put(
        `http://localhost:3000/api/staff/complaints/${complaintId}/status`,
        { status: newStatus },
        { headers: { Authorization: `Bearer ${token}` } }
      );
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
            <div style={{ textAlign: "right" }}>
              <p style={{
                ...
                Welcome, {staffName.charAt(0).toUpperCase() + staffName.slice(1)}
              </p>
              <p style={{
                margin: "0",
                fontSize: "12px",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                {assignedComplaints.filter(c => c.status.toLowerCase() === 'in progress').length}
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                {assignedComplaints.filter(c => c.status.toLowerCase() === 'resolved').length}
              </p>
            </div>
          </div>
              ...
              <div style={{ padding: "0" }}>
                {assignedComplaints.map((complaint, index) => (
                  <div
                    ...
                    style={{
                      padding: "24px",
                      borderBottom: index < assignedComplaints.length - 1 ? "1px solid #d6d6d6" : "none",
                      backgroundColor: "white"
                    }}
                  >
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <span style={{
                          ...
                          padding: "6px 12px",
                          backgroundColor: getStatusBackground(complaint.status),
